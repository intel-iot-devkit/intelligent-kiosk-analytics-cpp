...
static const char target_device_message[] = "Optional. Target device for Face Detection network (CPU, GPU, HDDL, FPGA or MYRIAD). " \
"The demo will look for a suitable plugin for a specified device.";

/// @brief Message for assigning age/gender calculation to device
static const char target_device_message_ag[] = "Optional. Target device for Age/Gender Recognition network (CPU, GPU, HDDL, FPGA or MYRIAD). " \
"The demo will look for a suitable plugin for a specified device.";

/// @brief Message for assigning head pose calculation to device
static const char target_device_message_hp[] = "Optional. Target device for Head Pose Estimation network (CPU, GPU, HDDL, FPGA or MYRIAD). " \
"The demo will look for a suitable plugin for a specified device.";
...
/// \brief Define a flag to enable asynchronous execution<br>
/// It is an optional parameter
DEFINE_uint32(async, true, async_message);
