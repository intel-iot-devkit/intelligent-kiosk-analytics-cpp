...
function( make_library name variant type )
  ...
  set_target_properties(${target} PROPERTIES "CMAKE_CXX_FLAGS" "${CMAKE_CXX_FLAGS} -fPIE"
COMPILE_PDB_NAME ${target})
  ...
  target_link_libraries( ${target} format_reader cpu_extension ${IE_LIBRARIES} gflags)
  if(UNIX)
...
function( make_executable name variant )
  ...
  add_dependencies(${target} gflags)
